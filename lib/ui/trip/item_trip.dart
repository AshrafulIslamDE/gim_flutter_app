...
class ItemTrip extends BaseItemView<TripItem> {
  @override
                ...
                children: <Widget>[
                  Padding(
                    ...
                    child: Row(
                      children: <Widget>[
                        Text(
                          AppTranslations.of(context).text('txt_trip_no').toUpperCase() + localize('number_count',dynamicValue: item.tripNumber.toString()),
                          style: TextStyle(color: ColorResource.warm_grey, fontSize:responsiveTextSize( 12),fontWeight: FontWeight.w500,
                              fontFamily: 'roboto'),
                        ),
